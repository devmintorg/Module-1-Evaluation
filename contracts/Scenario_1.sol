...
contract Scenario1 is Ownable {
    ...
    function changeExchangeRate(uint256 newExchangeRate) external onlyOwner {
        exchangeRate = newExchangeRate;
    } 

    function changeLockedTime(uint256 newLockedTimeMinutes) external onlyOwner {
        lockedTimeMinutes = newLockedTimeMinutes;
    } 
